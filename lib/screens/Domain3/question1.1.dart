...
class _QuestionState extends State<Question1> {
  ...
  getIntValues() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      tentative = prefs.getInt('tentative6');
    });
  }
  ...
  Widget build(BuildContext context) {
    // getUser();
    List<String> domain3Level1Questions = [
      ' Trouve le chat',
      ' Trouve le chien',
      ' Trouve la vache',
      ' Trouve la poule',
    ...
    List<String> d3l1q1options = [
      'Domain3Level1Image1',
      'Domain3Level1Image3',
      'Domain3Level1Image4',
      'Domain3Level1Image9'
    ];
    d3l1q1options.shuffle(Random());
    List<String> d3l1q2options = [
      'Domain3Level1Image0',
      'Domain3Level1Image7',
      'Domain3Level1Image2',
      'Domain3Level1Image8'
    ];
    d3l1q2options.shuffle(Random());
    List<String> d3l1q3options = [
      'Domain3Level1Image5',
      'Domain3Level1Image9',
      'Domain3Level1Image3',
      'Domain3Level1Image4'
    ];
    d3l1q3options.shuffle(Random());
    List<String> d3l1q4options = [
      'Domain3Level1Image1',
      'Domain3Level1Image0',
      'Domain3Level1Image7',
      'Domain3Level1Image4'
    ];
    d3l1q4options.shuffle(Random());
    List<String> d3l1q5options = [
      'Domain3Level1Image5',
      'Domain3Level1Image3',
      'Domain3Level1Image7',
      'Domain3Level1Image9'
    ];
    d3l1q5options.shuffle(Random());

    List<String> d3l1q6options = [
      'Domain3Level1Image6',
      'Domain3Level1Image8',
      'Domain3Level1Image1',
      'Domain3Level2Image2'
    ];
    d3l1q6options.shuffle(Random());
    List<String> d3l1q7options = [
      'Domain3Level1Image6',
      'Domain3Level1Image7',
      'Domain3Level1Image0',
      'Domain3Level1Image3'
    ];
    d3l1q7options.shuffle(Random());
    List<String> d3l1q8options = [
      'Domain3Level1Image8',
      'Domain3Level1Image4',
      'Domain3Level1Image2',
      'Domain3Level1Image5'
    ];
    d3l1q8options.shuffle(Random());

    List<String> d3l1q9options = [
      'Domain3Level1Image1',
      'Domain3Level1Image9',
      'Domain3Level1Image3',
      'Domain3Level1Image6'
    ];
    d3l1q9options.shuffle(Random());

    List<List> domain3Level1Indices = [
      d3l1q0options,
      d3l1q1options,
      d3l1q2options,
      d3l1q3options,
      ...
      if (k == 'Domain3Level1Image$i') {
        ...
        setState(() {
          if (i < 9) {
            i++;
            cpt = i + 1;
            setString("trace", 'Domain3Level1question$cpt');

            setInt("traceD3L1", i + 1);
          } else {
            Navigator.push(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () => {
                          changedLanguage(),
                          _onChange(domain3Level1Questions[i]),
                          _speak()
                        },
                        onDoubleTap: () => {_stop()},
                      ),
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level1Indices[i][0]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level1Indices[i][0] +
                                  '.png',
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level1Indices[i][1]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level1Indices[i][1] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                  ...
                  child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level1Indices[i][2]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level1Indices[i][2] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level1Indices[i][3]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level1Indices[i][3] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),

...
class _QuestionState extends State<Question3> {
  ...
  getIntValues() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      tentative2 = prefs.getInt('tentative8');
    });
  }
  ...
  Widget build(BuildContext context) {
    List<String> domain3Level3Questions = [
      ' Que mange le chat',
      ' Que mange le chien',
      ' Que mange la vache',
      ' Que mange la poule',
      ...
      " Que mange l'âne",
      ' Que mange le cheval',
      " Que mange l'éléphant",
      ' Que mange le lion'
    ];
    List<String> d3l3q0options = [
      'Domain3Level3Image0',
      'Domain3Level3Image3',
      'Domain3Level3Image4',
      'Domain3Level3Image8'
    ...
    List<String> d3l3q1options = [
      'Domain3Level3Image1',
      'Domain3Level3Image2',
      'Domain3Level3Image7',
      'Domain3Level3Image5'
    ];
    d3l3q1options.shuffle(Random());
    List<String> d3l3q2options = [
      'Domain3Level3Image0',
      'Domain3Level3Image8',
      'Domain3Level3Image2',
      'Domain3Level3Image9'
    ];
    d3l3q2options.shuffle(Random());
    List<String> d3l3q3options = [
      'Domain3Level3Image2',
      'Domain3Level3Image1',
      'Domain3Level3Image3',
      'Domain3Level3Image9'
    ];
    d3l3q3options.shuffle(Random());
    List<String> d3l3q4options = [
      'Domain3Level3Image4',
      'Domain3Level3Image5',
      'Domain3Level3Image7',
      'Domain3Level3Image9'
    ];
    d3l3q4options.shuffle(Random());
    List<String> d3l3q5options = [
      'Domain3Level3Image0',
      'Domain3Level3Image4',
      'Domain3Level3Image5',
      'Domain3Level3Image8'
    ];
    d3l3q5options.shuffle(Random());

    List<String> d3l3q6options = [
      'Domain3Level3Image1',
      'Domain3Level3Image3',
      'Domain3Level3Image0',
      'Domain3Level3Image6'
    ];
    d3l3q6options.shuffle(Random());
    List<String> d3l3q7options = [
      'Domain3Level3Image0',
      'Domain3Level3Image5',
      'Domain3Level3Image9',
      'Domain3Level3Image7'
    ];
    d3l3q7options.shuffle(Random());
    List<String> d3l3q8options = [
      'Domain3Level3Image0',
      'Domain3Level3Image2',
      'Domain3Level3Image8',
      'Domain3Level3Image1'
    ];
    d3l3q8options.shuffle(Random());

    List<String> d3l3q9options = [
      'Domain3Level3Image3',
      'Domain3Level3Image5',
      'Domain3Level3Image9',
      'Domain3Level3Image8'
    ];
    d3l3q9options.shuffle(Random());

    List<List> domain3Level3Indices = [
      d3l3q0options,
      d3l3q1options,
      d3l3q2options,
      d3l3q3options,
      ...
      if (k == 'Domain3Level3Image$i') {
        ...
        setState(() {
          if (i < 9) {
            i++;
            cpt = i + 1;
            setString("trace", 'Domain3Level3question$cpt');

            setInt("traceD3L3", i + 1);
          } else {
            Navigator.push(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () => {
                          changedLanguage(),
                          _onChange(domain3Level3Questions[i]),
                          _speak()
                        },
                        onDoubleTap: () => {_stop()},
                      ),
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level3Indices[i][0]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level3Indices[i][0] +
                                  '.png',
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level3Indices[i][1]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level3Indices[i][1] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                  ...
                  child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level3Indices[i][2]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level3Indices[i][2] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain3Level3Indices[i][3]),
                            child: Image.asset(
                              'assets/photos2/' +
                                  domain3Level3Indices[i][3] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),

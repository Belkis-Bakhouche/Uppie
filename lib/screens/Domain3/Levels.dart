...
class Levels3 extends StatefulWidget {
  @override
  _LevelsState createState() => _LevelsState();
}

class _LevelsState extends State<Levels3> {
            ...
            child: Column(
              children: [
                Row(children: [
                  ...
                  SizedBox(width: 0.666 * screenWidth),

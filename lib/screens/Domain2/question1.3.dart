...
class _QuestionState extends State<Question3> {
  ...
  getIntValues() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      tentative2 = prefs.getInt('tentative5');
    });
  }
  ...
  Widget build(BuildContext context) {
    List<String> domain2Level3Questions = [
      ' Où est la mangue?',
      " Où est l'ananas?",
      " Où est l'avocat?",
      " Où est le kiwi?",
      ' Où est le noix de coco?',
      " Où sont les pois?",
      " Où est l'épinard?",
      ' Où est le champignon?',
      ' Où est le choufleur?',
      ' Où est le maïs?'
    ];
    List<String> d2l3q0options = [
      'Domain2Level3Image0',
      'Domain2Level3Image2',
      'Domain2Level1Image4',
      'Domain2Level2Image2'
    ...
    List<String> d2l3q1options = [
      'Domain2Level2Image1',
      'Domain2Level2Image4',
      'Domain2Level2Image7',
      'Domain2Level3Image1'
    ];
    d2l3q1options.shuffle(Random());
    List<String> d2l3q2options = [
      'Domain2Level1Image0',
      'Domain2Level1Image3',
      'Domain2Level3Image2',
      'Domain2Level3Image4'
    ];
    d2l3q2options.shuffle(Random());
    List<String> d2l3q3options = [
      'Domain2Level2Image3',
      'Domain2Level3Image1',
      'Domain2Level3Image3',
      'Domain2Level3Image7'
    ];
    d2l3q3options.shuffle(Random());
    List<String> d2l3q4options = [
      'Domain2Level1Image2',
      'Domain2Level1Image4',
      'Domain2Level3Image4',
      'Domain2Level3Image8'
    ];
    d2l3q4options.shuffle(Random());
    List<String> d2l3q5options = [
      'Domain2Level1Image3',
      'Domain2Level2Image1',
      'Domain2Level2Image4',
      'Domain2Level3Image5'
    ];
    d2l3q5options.shuffle(Random());

    List<String> d2l3q6options = [
      'Domain2Level1Image1',
      'Domain2Level3Image3',
      'Domain2Level3Image9',
      'Domain2Level3Image6'
    ];
    d2l3q6options.shuffle(Random());
    List<String> d2l3q7options = [
      'Domain2Level1Image4',
      'Domain2Level1Image8',
      'Domain2Level2Image9',
      'Domain2Level3Image7'
    ];
    d2l3q7options.shuffle(Random());
    List<String> d2l3q8options = [
      'Domain2Level1Image2',
      'Domain2Level3Image2',
      'Domain2Level3Image8',
      'Domain2Level3Image5'
    ];
    d2l3q8options.shuffle(Random());

    List<String> d2l3q9options = [
      'Domain2Level1Image6',
      'Domain2Level2Image7',
      'Domain2Level3Image9',
      'Domain2Level3Image1'
    ];
    d2l3q9options.shuffle(Random());

    List<List> domain2Level3Indices = [
      d2l3q0options,
      d2l3q1options,
      d2l3q2options,
      d2l3q3options,
      ...
      if (k == 'Domain2Level3Image$i') {
        ...
        setState(() {
          if (i < 9) {
            i++;
            cpt = i + 1;
            setString("trace", 'Domain2Level3question$cpt');

            setInt("traceD2L3", i + 1);
          } else {
            Navigator.push(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        onTap: () => {
                          changedLanguage(),
                          _onChange(domain2Level3Questions[i]),
                          _speak()
                        },
                        onDoubleTap: () => {_stop()},
                      ),
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain2Level3Indices[i][0]),
                            child: Image.asset(
                              'assets/photos1/' +
                                  domain2Level3Indices[i][0] +
                                  '.png',
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain2Level3Indices[i][1]),
                            child: Image.asset(
                              'assets/photos1/' +
                                  domain2Level3Indices[i][1] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                  ...
                  child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain2Level3Indices[i][2]),
                            child: Image.asset(
                              'assets/photos1/' +
                                  domain2Level3Indices[i][2] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                checkanswer(domain2Level3Indices[i][3]),
                            child: Image.asset(
                              'assets/photos1/' +
                                  domain2Level3Indices[i][3] +
                                  '.png',
                              width: 0.44444 * screenWidth,
                              height: 0.238095 * screenHeight,
                            ),
